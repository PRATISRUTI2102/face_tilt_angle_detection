...
face_cascade = cv.CascadeClassifier(r'C:\CODING\PYTHON PROJECTS\FACE_TILT\haarcascade_frontalface_default.xml')
eye_cascade = cv.CascadeClassifier(r'C:\CODING\PYTHON PROJECTS\FACE_TILT\haarcascade_eye.xml')
